...
- Name: assistant-ui-reference-client.spec.ts >> assistant-ui hosted browser reference proof >> Test B - Tool Request
- Location: tests/assistant-ui-reference-client.spec.ts:286:3
