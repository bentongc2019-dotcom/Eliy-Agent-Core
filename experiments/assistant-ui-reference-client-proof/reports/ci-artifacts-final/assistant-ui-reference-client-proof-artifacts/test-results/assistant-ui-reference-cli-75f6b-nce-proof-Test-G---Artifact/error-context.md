...
- Name: assistant-ui-reference-client.spec.ts >> assistant-ui hosted browser reference proof >> Test G - Artifact
- Location: tests/assistant-ui-reference-client.spec.ts:391:3
