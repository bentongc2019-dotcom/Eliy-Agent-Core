...
|---|---|---|---|
| tool_requested | SDK Result/State object: RunResult.interruptions[] / RunToolApprovalItem.rawItem | Credential Blocked | Yes |
| run_interrupted | SDK Result/State object: RunResult.interruptions.length > 0 / RunState.getInterruptions() | Credential Blocked | Yes |
...
| run_completed | SDK Result object: RunResult.finalOutput and zero pending interruptions | Not fully proven | Yes |
